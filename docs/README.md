...
Stand der Ablage: 2026-09-12

| Ordner                                        | Inhalt                                                                                                                                                   |
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`anforderungskatalog/`](anforderungskatalog) | Ausschreibungsbeilagen (A1.1 Mitwirkungspflichten, A1.2 Abnahmevorschrift, A2, B1, B1.4–B1.7); [index.md](anforderungskatalog/index.md) = Lesehilfe, Ampel-Regeln, Berechnungsformeln, Prototyp-Prioritäten; [umsetzungsstand.md](anforderungskatalog/umsetzungsstand.md) = **Stand für die nächste Sitzung** (umgesetzt / vereinfacht / offen, Demo-Pfad); [C2-Loesungskonzept-SLIM.md](anforderungskatalog/C2-Loesungskonzept-SLIM.md) = Lösungskonzept v0.3 vom 21.09.2026 (Quelle; `npm run docs:docx -- <md> --pages` erzeugt die Word-Fassung und zählt die Seiten; `…-Entwurf.docx` = v0.1); [checkliste.md](anforderungskatalog/checkliste.md) = Prüfstand des Konzepts (12.09.2026); [validierung-fachlich.md](anforderungskatalog/validierung-fachlich.md) / [validierung-technisch.md](anforderungskatalog/validierung-technisch.md) = Validierung des Prototyps gegen B1 (Fachlogik, Datenmodell Kap. 10, NFA 12.5–12.7); [nachweis-rechenfaelle.md](anforderungskatalog/nachweis-rechenfaelle.md) = ausgeführte Rechenfälle durch die Kette (Testplatz S, Commit, Befunde) |
...
| [`projects/`](projects)                       | Laufende Vorhaben mit eigenem Plan; [hermes-projektplan-z3.md](projects/hermes-projektplan-z3.md) = HERMES-Projektmanagementplan / Projektplan Z3 (Arbeitsentwurf v0.2, 12.09.2026) |

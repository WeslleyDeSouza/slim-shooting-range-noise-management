...
| Verteilung auf Quellen (B1 7.5, `slm 32`, Review T02) | `distributeShots` im Kern: Gewichte aus den Betriebsdaten, alle Gewichte 0 → Gleichverteilung + Warnung, Dezimalmengen summentreu; Anbindung an das Modell folgt mit den Quellen je Zustand | `distribution.spec` (6 Fälle) |

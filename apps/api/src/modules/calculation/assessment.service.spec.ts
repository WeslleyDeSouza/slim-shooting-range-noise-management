...
/** Demo reference values of dataset v6 (tools/tenant-dataset.generator.ts, regenerated
 * 2026-09-19 with the fractional time split: A1L/A2R sources 6879/1321 and 4579/3121 shots
 * inside/outside, WLR retuned). E5 A9 recalculated: 61.9 dB. */
const EXPECTED = {
